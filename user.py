from main import sync_lists, sync_movie_watch_history, sync_show_watch_history, sync_watchlist
...
if __name__ == "__main__":
    ...
    sync_all = clean_bool_input("Do you want to sync all data (lists, watch history, and watchlist)? (y/n): ")

    sync_lists_choice = sync_show_watch_history_choice = sync_movie_watch_history_choice = sync_watchlist_choice = True
